...
import { getFirestore, addDoc, doc, collection, Timestamp,runTransaction, increment } from "firebase/firestore";
...
export { auth, storage, app, db, addDoc, collection, Timestamp, doc, runTransaction, increment };
